...
from patrans_core.utils.comm import get_world_size, synchronize
from patrans_core.utils.metric_logger import MetricLogger
...
def do_train(
    ...
    logger = logging.getLogger("patrans_core.trainer")
