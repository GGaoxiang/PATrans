...
from patrans_core.modeling import registry
from patrans_core.modeling.box_coder import BoxCoder
from patrans_core.modeling.rpn.retinanet.retinanet import build_retinanet
from patrans_core.modeling.rpn.fcos.fcos import build_fcos
from patrans_core.modeling.rpn.borderdet.borderdet import build_border
# from patrans_core.modeling.rpn.fcos_patrans.fcos_stft import build_fcos_stft
from patrans_core.modeling.rpn.fcos_patrans.fcos_patrans import build_fcos_patrans
...
def build_rpn(cfg, in_channels):
    ...
    if cfg.MODEL.PATRANS_ON and cfg.MODEL.FCOS_ON:
        return build_fcos_patrans(cfg, in_channels)
    
    # if cfg.MODEL.STFT_ON and cfg.MODEL.FCOS_ON:
    #     return build_fcos_stft(cfg, in_channels)

    if cfg.MODEL.FCOS_ON:
        return build_fcos(cfg, in_channels)

    if cfg.MODEL.BORDER_ON:
        return build_border(cfg, in_channels)
