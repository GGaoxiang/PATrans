...
_C.MODEL.BORDER_ON = False
_C.MODEL.STFT_ON = False
_C.MODEL.PATRANS_ON = True
...
_C.MODEL.RPN.ANCHOR_SIZES = (64, 128, 256, 512) # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!(32, 64, 128, 256, 512)
...
# regression loss / (pos_bbox_num + neg_bbox_num)
_C.MODEL.RPN.REG_LOSS_DIV_POS = False
# Number of top scoring RPN proposals to keep before applying NMS
# When FPN is used, this is *per FPN level* (not total)
_C.MODEL.RPN.PRE_NMS_TOP_N_TRAIN = 6000 # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!  12000
_C.MODEL.RPN.PRE_NMS_TOP_N_TEST = 6000
# Number of top scoring RPN proposals to keep after applying NMS
_C.MODEL.RPN.POST_NMS_TOP_N_TRAIN = 300 # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 2000
_C.MODEL.RPN.POST_NMS_TOP_N_TEST = 300 # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! !! 1000
...
_C.MODEL.ROI_HEADS.BATCH_SIZE_PER_IMAGE = 128  # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 512
# Target fraction of RoI minibatch that is labeled foreground (i.e. class > 0)
_C.MODEL.ROI_HEADS.POSITIVE_FRACTION = 0.25
# regression loss / (pos_bbox_num + neg_bbox_num)
_C.MODEL.ROI_HEADS.REG_LOSS_DIV_POS = False
...
_C.MODEL.ROI_HEADS.SCORE_THRESH = 0.05  # 0.001
...
_C.MODEL.RESNETS.RES5_DILATION = 2  # !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! !!!!!!!!!!!!!!!!!!! !!!!!!!!!!!!!!!!!!! !!!!!!!!!!!!!!!!!!!  1
...
# ---------------------------------------------------------------------------- #
_C.MODEL.BORDER = CN()
_C.MODEL.BORDER.IOU_THRESH = 0.6
_C.MODEL.BORDER.BBOX_STD = [0.5, 0.5, 0.5, 0.5]

# ---------------------------------------------------------------------------- #
# STFT Options
# ---------------------------------------------------------------------------- #
_C.MODEL.STFT = CN()
_C.MODEL.STFT.OFFSET_WEIGHT_STD = 0.01
_C.MODEL.STFT.IOU_THRESH = 0.1
_C.MODEL.STFT.BBOX_STD = [0.5, 0.5, 0.5, 0.5]
_C.MODEL.STFT.REG_BETA = 0.11

# ---------------------------------------------------------------------------- #
# Transformer Options
# ---------------------------------------------------------------------------- #
_C.MODEL.TRANS = CN()
_C.MODEL.TRANS.PREV_IMG_MODE = "after_ST"
_C.MODEL.TRANS.SUP_GT_MODE = "align_ltrb_off"
_C.MODEL.TRANS.MODEL_ENCODER_EMBEDDING_DIM_CLS = 256
_C.MODEL.TRANS.MODEL_ENCODER_EMBEDDING_DIM_REG = 256 
_C.MODEL.TRANS.MODEL_DECODER_INTERMEDIATE_PATRANS = True
_C.MODEL.TRANS.MODEL_SELF_COSPOSITION = True
_C.MODEL.TRANS.MODEL_CROSS_ATT_COSPOSITION= True
_C.MODEL.TRANS.MODEL_SELF_HEADS = 8
_C.MODEL.TRANS.MODEL_ATT_HEADS = 8
_C.MODEL.TRANS.MODEL_PATRANS_NUM = 1
_C.MODEL.TRANS.MODEL_EPSILON = 1e-5
_C.MODEL.TRANS.TRAIN_PATRANS_EMB_DROPOUT = 0.
_C.MODEL.TRANS.TRAIN_PATRANS_DROPPATH = 0.1
_C.MODEL.TRANS.TRAIN_PATRANS_DROPPATH_SCALING = False
_C.MODEL.TRANS.TRAIN_PATRANS_DROPPATH_LST = False
_C.MODEL.TRANS.TRAIN_PATRANS_GLOBAL_DROPOUT = 0.
_C.MODEL.TRANS.TRAIN_PATRANS_LOCAL_DROPOUT = 0.
_C.MODEL.TRANS.PATCH_NUM = 4
_C.MODEL.TRANS.MAX_DIS = 7
_C.MODEL.TRANS.MODEL_MAX_OBJ_NUM = 1
_C.MODEL.TRANS.TRANS_FEAT_LAYER = 2
_C.MODEL.TRANS.VIEW_NUM = 4
# ---------------------------------------------------------------------------- #
...
# ---------------------------------------------------------------------------- #
# CENTERNET specfic options
# ---------------------------------------------------------------------------- #
_C.MODEL.CENTERNET = CN()
_C.MODEL.CENTERNET.CHANNEL_HM = 80
_C.MODEL.CENTERNET.CHANNEL_WH = 2
_C.MODEL.CENTERNET.CHANNEL_OFFSET = 2
_C.MODEL.CENTERNET.HEAD_CONV = 64
_C.MODEL.CENTERNET.WEIGHT_HM = 1.0
_C.MODEL.CENTERNET.WEIGHT_WH = 0.1
_C.MODEL.CENTERNET.WEIGHT_OFFSET = 1.0
_C.MODEL.CENTERNET.WEIGHT_MASK = 0.1

_C.MODEL.CENTERNET.RAND_CROP = True
_C.MODEL.CENTERNET.FIX_RESIZE = False
_C.MODEL.CENTERNET.INPUT_SCALE = 512

_C.MODEL.CENTERNET.NUM_HEADS = 1
...
_C.MODEL.VID.FLOWNET_WEIGHT = "pretrained_models/flownet.ckpt"
...
# STFT
_C.MODEL.VID.STFT = CN()
_C.MODEL.VID.STFT.MIN_OFFSET = -9
_C.MODEL.VID.STFT.MAX_OFFSET = 9

_C.MODEL.VID.STFT.TRAIN_REF_NUM = 2
_C.MODEL.VID.STFT.TEST_REF_NUM = 10

# PATRANS
_C.MODEL.VID.PATRANS = CN()
_C.MODEL.VID.PATRANS.MIN_OFFSET = -9
_C.MODEL.VID.PATRANS.MAX_OFFSET = 9

_C.MODEL.VID.PATRANS.TRAIN_REF_NUM = 2
_C.MODEL.VID.PATRANS.TEST_REF_NUM = 10
...
_C.SOLVER.LR_TYPE = "step"
_C.SOLVER.GAMMA = 0.1
_C.SOLVER.STEPS = (30000,)
_C.SOLVER.MIN_LR = 0.0000001
