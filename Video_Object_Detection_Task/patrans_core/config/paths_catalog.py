...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        "CVCVideo_train_videos": {
            "img_dir": "CVCVideo/Data",
            "anno_path": "CVCVideo/Annotations",
            "img_index": "CVCVideo/ImageSets/CVCVideo_train_videos.txt"
        },
        "CVCVideo_val_videos": {
            "img_dir": "CVCVideo/Data",
            "anno_path": "CVCVideo/Annotations",
            "img_index": "CVCVideo/ImageSets/CVCVideo_val_videos.txt"
        },
        ####################### polyp ASUMayo #######################
    ...
    def get(name, method="base"):
        dataset_dict = {
            ...
            "cvc_patrans": "CVCVIDPATRANSDataset"
