...
from patrans_core.utils.comm import get_world_size
from patrans_core.utils.imports import import_file
from patrans_core.utils.miscellaneous import save_labels
...
def make_data_loader(cfg, is_train=True, is_distributed=False, start_iter=0, is_for_period=False):
    ...
    paths_catalog = import_file(
        "stft_core.config.paths_catalog", cfg.PATHS_CATALOG, True
    )
