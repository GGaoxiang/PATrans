...
def do_vid_evaluation(dataset, predictions, output_folder, box_only, motion_specific, logger, vis_thr):
    pred_boxlists = []
    gt_boxlists = []
...
def eval_detection_vid(pred_boxlists,
    ...
    motion_iou_file = "stft_core/data/datasets/evaluation/vid/vid_groundtruth_motion_iou.mat"
