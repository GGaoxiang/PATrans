...
from patrans_core.utils.model_serialization import load_state_dict
from patrans_core.utils.c2_model_loading import load_c2_format
from patrans_core.utils.imports import import_file
from patrans_core.utils.model_zoo import cache_url
    ...
    def _load_file(self, f):
        ...
        if f.startswith("catalog://"):
            paths_catalog = import_file(
                "stft_core.config.paths_catalog", self.cfg.PATHS_CATALOG, True
            )
